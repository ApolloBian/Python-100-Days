## Python 滴水计划
fork这个仓库的原因是我要做一些长期的小项目,选来选去,决定从基础的语言开始做起. 对于这个项目,基本要求是一天一章,简单的部分可以一天多章. 时间控制在1-2小时内,作为长期的项目,一开始占用的时间过长不利于形成习惯.

注意,我对于自身的要求是要形成习惯,而不是为了刷题/其他. 一定要牢记自己的初心. 正如标题所言, 滴水穿石,最为可贵.
